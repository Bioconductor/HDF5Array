...
{
    .Call2("C_destroy_DSetHandle_xp", xp, PACKAGE="HDF5Array")
}

DSetHandle <- function(filepath, name, as.integer=FALSE)
{
    xp <- .Call2("C_create_DSetHandle_xp", filepath, name, as.integer,
                                           PACKAGE="HDF5Array")
...
setMethod("show", "DSetHandle",
    function(object)
        .Call2("C_show_DSetHandle_xp", object@xp, PACKAGE="HDF5Array")
)
