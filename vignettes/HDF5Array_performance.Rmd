...
date: "Compiled `r doc_date()`; Modified 11 February 2025"
package: HDF5Array
vignette: |
...
are DelayedMatrix objects that carry delayed operations. These can
be displayed with `showtree()` e.g. for `norm_brain1_s`:
...
_[Timings for this machine will be added soon.]_
...
of the same dataset (e.g. on a SparseMatrix object) takes less then 4 minutes.
However, that consumes about 18.5Gb of memory! This will be the subject of
a separate vignette in the `r Biocpkg("SparseArray")` package.
