...
date: "Compiled `r doc_date()`; Modified 31 January 2025"
package: HDF5Array
vignette: |
...
than the other machines. This is likely due to the less performant disk.

The "**[Ds]** HDF5Matrix as sparse" representation didn't live up to
its promise so we leave it alone for now.
...
- However, it should be noted that the "**[D]** HDF5Matrix (dense)"
  representation seems to be significantly better than the
  "**[s]** TENxMatrix (sparse)" representation at keeping memory
  usage flat as the number of cells in the dataset increases.
