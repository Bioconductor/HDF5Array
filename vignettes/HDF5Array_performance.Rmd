...
date: "Compiled `r doc_date()`; Modified 26 January 2025"
package: HDF5Array
vignette: |
...
```
_Notes:_
- _For each operation, the best time across the three different block sizes
  is displayed in **bold**;_
- _The "max. mem. used" columns to be populated soon._
