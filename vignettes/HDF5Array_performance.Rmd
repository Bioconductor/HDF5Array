...
date: "Compiled `r doc_date()`; Modified 25 January 2025"
package: HDF5Array
vignette: |
...
- on-disk realization of the normalized sparse datasets: 40 Mb
...
```{r xps15_timings_1k_var_genes, echo=FALSE, results='asis'}
make_timings_table("xps15", num_var_genes="1000")
```
...
```{r rex3_timings_1k_var_genes, echo=FALSE, results='asis'}
make_timings_table("rex3", num_var_genes="1000")
```
_Note: "max. mem. used" columns to be populated soon._
...
```{r kjohnson3_timings_1k_var_genes, echo=FALSE, results='asis'}
make_timings_table("kjohnson3", num_var_genes="1000")
```
_Note: "max. mem. used" columns to be populated soon._
