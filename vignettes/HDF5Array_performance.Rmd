...
For our benchmarks below, we'll use the following block sizes:
  ...
  | HDF5Matrix as sparse |        250 Mb |              100 Mb |  16 Mb |
...
block sizes (16 Mb) is a clear winner.
...
_[TODO] Revisit the paragraph below now that we have timings for blocks
of 16 Mb._

However, based on the above benchmarks, there's no clear best choice
