...
date: "Compiled `r doc_date()`; Modified 24 January 2025"
package: HDF5Array
vignette: |
...
make_timings_table("xps15", num_var_genes=1000L)
```
...
make_timings_table("rex3", num_var_genes=1000L)
```
_Note: "max. mem. used" columns to be populated soon._
...
make_timings_table("kjohnson3", num_var_genes=1000L)
```
_Note: "max. mem. used" columns to be populated soon._
