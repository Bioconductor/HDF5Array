# This tests the ability of the API to properly access numeric HDF5Matrices.
# library(testthat); source("setup.R"); source("test-numeric.R")
...
test_that("HDF5 numeric matrix input is okay", {
    ...
    check_read_class(hFUN(), mode="numeric", "HDF5Matrix")
